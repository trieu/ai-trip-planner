...
from .web_search import search_or_fallback
...
__all__ = ["get_current_user", "get_costs", "get_destination_info", "get_current_weather", "make_cache_key", "get_cache",
           "set_cache", "set_cache_with_ttl", "canonicalize_city_name", "looks_vietnamese", "normalize_text", "merge_unique_csv", "search_or_fallback"]
